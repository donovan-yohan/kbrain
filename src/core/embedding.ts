...
/**
 * USD cost per 1k tokens for text-embedding-3-large. Used by sync cost
 * preview. For local OpenAI-compatible servers actual cost is $0; this
 * constant is the cloud-OpenAI baseline.
 */
